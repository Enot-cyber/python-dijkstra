...
# Список заказов
orders = [
    {'from': (10, 20), 'to': (30, 40), 'cost': 50},
    {'from': (15, 25), 'to': (35, 45), 'cost': 70},
    {'from': (20, 30), 'to': (40, 50), 'cost': 60},
    {'from': (25, 35), 'to': (45, 55), 'cost': 80},
    {'from': (30, 40), 'to': (50, 60), 'cost': 90},
    {'from': (35, 45), 'to': (55, 65), 'cost': 100},
    {'from': (40, 50), 'to': (60, 70), 'cost': 110},
    {'from': (45, 55), 'to': (65, 75), 'cost': 120},
    {'from': (50, 60), 'to': (70, 80), 'cost': 130},
    {'from': (55, 65), 'to': (75, 85), 'cost': 140},
]
